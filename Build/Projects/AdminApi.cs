...
{
    public class AdminApi : IProject
    {
        public string Name => "AdminAPI";
        public string ProjectSourceDir => "Mergen.Admin.Api";
        ...
        public void AddTasks()
        {
            ...
            var publishTask = this.Task("Publish")
                .Does<BuildData>((context, buildData) =>
                {
                    var publishPath = buildData.ApplicationsPublishPath.Combine("AdminApi");
            ...
            var deployTask = this.Task("Deploy")
                ...
                .Does<BuildData>((context, buildData) =>
                {
                    var deployPath = context.Argument<string>("AdminApi.DeployPath");
